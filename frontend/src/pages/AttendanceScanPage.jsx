...
export default function AttendanceScanPage() {
    ...
    if (loading) return <div className="h-screen flex items-center justify-center font-bold text-brand-blue animate-pulse text-[20px]">KAROBAR SCANNER...</div>;
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] flex flex-col items-center px-[20px] py-[60px]">
            ...
            <p className="mt-[40px] text-[12px] font-medium text-text-muted flex items-center gap-[8px]">
               <Clock size={14} /> Karobar Biometric Cloud v1.0
            </p>
        </div>
    );
}
